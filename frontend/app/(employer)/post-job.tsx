...
export default function PostJobScreen() {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 5:
        return formData.scheduled_date && formData.start_time && formData.end_time;
      default:
        return false;
    }
  };
  ...
  const renderStep5 = () => (
    <View style={styles.stepContent}>
      <Text style={styles.stepTitle}>Schedule the Job</Text>
      <Text style={styles.stepSubtitle}>When do you need the worker?</Text>
      ...
      <View style={styles.inputGroup}>
        ...
        />
        <Text style={styles.helpText}>24-hour format (e.g., 09:00 for 9 AM)</Text>
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        />
        <Text style={styles.helpText}>24-hour format (e.g., 17:00 for 5 PM)</Text>
      </View>

      {/* Preview */}
      {formData.scheduled_date && formData.start_time && formData.end_time && (
        <View style={styles.schedulePreview}>
          <Ionicons name="calendar" size={24} color={COLORS.employer.primary} />
          <View style={{ flex: 1, marginLeft: SPACING.md }}>
            <Text style={styles.schedulePreviewTitle}>Job Schedule</Text>
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        {/* Footer Buttons - Now inside SafeArea and above keyboard */}
