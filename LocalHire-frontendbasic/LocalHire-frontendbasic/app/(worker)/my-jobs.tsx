...
export default function MyJobsScreen() {
  ...
  const loadApplications = async () => {
    try {
      ...
      const acceptedJobs = data.filter((app: any) => app.status === 'accepted');
      setApplications(acceptedJobs);
    } catch (error) {
  ...
  const getFilteredApplications = () => {
    return applications.filter(app => {
      const workStatus = getWorkStatus(app);
      ...
      <View style={styles.jobCard}>
        <View style={styles.jobHeader}>
          <View style={styles.jobTitleContainer}>
            ...
            <View style={[
              styles.statusBadge,
              workStatus === 'completed' && styles.completedBadge
            ]}>
              <Text style={[
                styles.statusText,
                workStatus === 'completed' && styles.completedText
              ]}>
                {workStatus === 'completed' ? 'Completed' : 'In Progress'}
              </Text>
            </View>
          </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>No {selectedTab === 'in_progress' ? 'ongoing' : 'completed'} jobs</Text>
