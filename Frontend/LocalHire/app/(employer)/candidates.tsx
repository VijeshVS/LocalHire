...
const candidates = [
  {
    ...
    skills: ['Painting', 'Color Mixing', 'Interior Design'],
    appliedFor: 'Experienced Painter',
    ...
    lastSeen: 'Online',
    reviews: [
      { rating: 5, comment: 'Excellent work quality', employer: 'Rajesh' },
      { rating: 5, comment: 'Very professional', employer: 'Priya' },
    ]
  },
  {
    id: '2',
    ...
    lastSeen: '2 min ago',
    reviews: [
      { rating: 5, comment: 'Very thorough cleaning', employer: 'Amit' },
      { rating: 4, comment: 'Good service', employer: 'Neha' },
    ]
  },
  {
    id: '3',
    ...
    lastSeen: '1 hour ago',
    reviews: [
      { rating: 4, comment: 'Strong and reliable', employer: 'Kavya' },
    ]
  }
];

const filterOptions = [
  { id: 'all', label: 'All Applications', count: 26 },
  { id: 'new', label: 'New', count: 8 },
  { id: 'shortlisted', label: 'Shortlisted', count: 5 },
  { id: 'interviewed', label: 'Interviewed', count: 3 },
    ...
    switch (action) {
      ...
      case 'hire':
        Alert.alert('Hire', `Hire ${candidate.name} for this job?`, [
          { text: 'Cancel', style: 'cancel' },
          { text: 'Hire', onPress: () => console.log('Candidate hired') }
        ]);
        break;
      case 'message':
